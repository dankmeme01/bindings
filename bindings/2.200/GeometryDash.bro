...
class LoadingLayer : cocos2d::CCLayer {
	...
	void loadingFinished() = win 0x2722A0, mac 0x368f60;
...
class GJBaseGameLayer : cocos2d::CCLayer, TriggerEffectDelegate {
	...
	PAD = win 0xd2, android32 0xba, android64 0xf0, mac 0x100;
	gd::vector<PlayerButtonCommand> m_queuedButtons; 
	PAD = win 0x20a, android32 0x1ea, android64 0x340, mac 0x320;
}
...
class GameLevelManager : cocos2d::CCNode {
	...
	TodoReturn uploadUserMessage(int, gd::string, gd::string) = mac 0x51ce90;
	...
	TodoReturn deleteUserMessages(GJUserMessage*, cocos2d::CCArray*, bool) = mac 0x51d450;
...
class PlayerObject : GameObject, AnimatedSpriteDelegate {
	...
	TodoReturn playSpiderDashEffect(cocos2d::CCPoint, cocos2d::CCPoint) = mac 0x3ef720;
	...
	TodoReturn enableCustomGlowColor(cocos2d::_ccColor3B const&) = mac 0x3fa900;
	...
	TodoReturn updatePlayerRobotFrame(int) = mac 0x3fb000;
	...
	TodoReturn updatePlayerSpiderFrame(int) = mac 0x3fb020;
